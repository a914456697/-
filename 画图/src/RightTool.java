...
public class RightTool extends JPanel implements ActionListener ,ChangeListener{
	...
	private boolean isShan;// 判断是否是扇形
	...
	public RightTool() {
		...
		borderPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(204,204,204)) ,"边框",TitledBorder.LEFT,TitledBorder.TOP,font));
		borderPanel.add(dx);
		...
		setPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(204,204,204)) ,"扇形设定",TitledBorder.LEFT,TitledBorder.TOP,font));
		xz = new JLabel("弦状:");
		xz.setFont(font2);
		kf = new JLabel("开放:");
		kf.setFont(font2);
